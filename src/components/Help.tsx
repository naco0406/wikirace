            ...
            <DialogContent className="rounded-lg p-6 pt-8 max-w-sm max-h-[calc(100vh-4rem)] flex flex-col">
                ...
                <div className="space-y-6 overflow-y-auto scrollbar-hide">
                    <div className="space-y-4 break-normal">
                        <div>
                            <span className="font-['Rhodium_Libre'] text-[#3366CC] font-[400]">Linkle</span>은 <a href="https://en.wikipedia.org/wiki/Wikiracing" target="_blank" rel="noopener noreferrer" className="underline font-semibold">WikiRacing</a> 게임의 규칙을 기반으로 한 한국어 위키백과 탐험 게임입니다.
                        </div>
                        <div>
